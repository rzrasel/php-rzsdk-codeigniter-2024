...
?>
<?php
class TblUserManualAccountQuery extends TblUserManualAccount {
    ...
    private function getSQLiteColumnProperty() {
        $tablePropertyList = array(
            ...
            $this->security_question    => "TEXT NULL",
            $this->security_answer  => "TEXT NULL",
            $this->is_email_verified    => "BOOLEAN NOT NULL DEFAULT TRUE",
            $this->is_mobile_verified   => "BOOLEAN NOT NULL DEFAULT TRUE",
