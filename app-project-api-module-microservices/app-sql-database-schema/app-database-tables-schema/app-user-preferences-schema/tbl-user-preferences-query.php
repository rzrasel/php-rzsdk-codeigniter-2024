...
?>
<?php
class TblUserPreferencesQuery extends TblUserPreferences {
    ...
    private function getSQLiteColumnProperty() {
        $tablePropertyList = array(
            ...
            $this->dark_mode        => "BOOLEAN NOT NULL DEFAULT FALSE",
            $this->notifications_enabled    => "BOOLEAN NOT NULL DEFAULT TRUE",
            $this->timezone         => "VARCHAR(50) NOT NULL DEFAULT 'UTC'",
            $this->locale           => "VARCHAR(10) NOT NULL DEFAULT 'en'",
