...
<head>
    ...
    <title>User Password API Documentation</title>
...
<div class="container" id="top">
    ...
    <div class="content">
        <h1>🔑 User Password API Documentation</h1>
        ...
        <!-- Add some space under the anchor menu -->
        <div style="height: 30px;"></div>

        <section id="endpoint" class="api-section">
            <h2>API Endpoint <span class="method-tag">POST</span></h2>
            <code><?= dirname($baseUrl) . "/app-microservice-user-password/"; ?></code>
        </section>

        <section id="overview" class="api-section">
            <h2>Overview</h2>
            <p>This endpoint registers or updates a user's password in the system.</p>
            <ul>
  ...
  "data": {
    "user_id": "989898",
    "id": "174654026839412959",
    "hash_type": null,
    "password_salt": null,
    "password_hash": "123456",
    "expiry": null,
    "status": null,
    "modified_date": "2025-05-06 16:04:28",
    "created_date": "2025-05-06 16:04:28",
    "modified_by": "989898",
    "created_by": "989898"
  },
  "status_code": 201
