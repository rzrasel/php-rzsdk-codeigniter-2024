...
?>
<?php
class ArabicVowelLetterModel {
    public static function run($dirFileList) {
        $drawableList = $dirFileList["drawable"];
        $rawList = $dirFileList["raw"];
        self::arabicVowelLetterModel($drawableList, $rawList);
    }

    private static function arabicVowelLetterModel($drawableList, $rawList) {
        echo "\n";
        echo "\n";
        echo "\n";
        echo "\n";
        ...
        echo "\n";
        echo "data class ArabicVowelLetterModel(";
        echo "\n";
        echo "@SuppressLint(\"ResourceType\") val arabicVowelModel: ";
        echo "\n";
