...
function runWriteHtmlFile($fileData) {
    ...
    $filename = "../file-write/full-image-gallery.html";
...
function runGenerateHtmlFile($requestData) {
    ...
    if(!empty($_POST["btn_generate_html_file"])) {
        ...
        $directoryStructure = DirectoryTraverseRetrieve::traverseDirectoryRetrieve($scannedDirectory, "root", '', 0, 2, $acceptedFileExtension);
        ...
        $fileData = DirectoryFileReader::traverseDirectoryRead($targetDirPath, $rearrangedData, $acceptedFileExtension, $readingFileExtension);
...
<div class="main-body-container">
    ...
    <main class="body-container">
        ...
        <header class="body-page-header">
            <h2>Directory Scan and Generate HTML Full Image Gallery</h2>
        </header>
