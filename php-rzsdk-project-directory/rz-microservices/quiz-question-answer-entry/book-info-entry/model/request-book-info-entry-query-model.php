<?php
namespace RzSDK\Quiz\Model\HTTP\Request\Book\Information\Parameter;
?>
<?php
...
?>
<?php
class RequestBookInfoEntryQueryModel extends GlobalRequestParameterModel {
    ...
    public function getEntryFormName() {
        $parameterModel = new GlobalRequestParameterModel();
        $tempLanguageEntryForm = $parameterModel->book_info_entry_form;
        $parameterModel = null;
