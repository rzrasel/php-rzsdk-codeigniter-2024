...
use RzSDK\Quiz\Activity\Category\Token\Entry\CategoryTokenEntryActivity;
...
$mainHtmlView->setPageTitle("Category Token Entry")
    ->setCss()
    ->setSideNavigation($sideNavigation)
    ->setPageHeader("Category Token Entry");
...
<table width="100%">
    <tr>
        <td height="50px">
<?php
$categoryTokenEntryActivity = new CategoryTokenEntryActivity(
...
$categoryTokenEntryActivity->execute($_POST);
?>
        </td>
    </tr>
</table>
<?php
require_once("view/category-token-entry-form.php");
?>
<?php
