...
use RzSDK\Quiz\Activity\Book\Token\Entry\BookTokenEntryActivity;
...
$mainHtmlView->setPageTitle("Book Token Entry")
    ->setCss()
    ->setSideNavigation($sideNavigation)
    ->setPageHeader("Book Token Entry");
...
<table width="100%">
    <tr>
        <td height="50px">
<?php
$bookTokenEntryActivity = new BookTokenEntryActivity(
...
$bookTokenEntryActivity->execute($_POST);
?>
        </td>
    </tr>
</table>
<?php
require_once("view/book-token-entry-form.php");
?>
<?php
