...
?>
<?php
class TblSectionInfoQuery extends TblSectionInfo {
    ...
    private function getSQLiteColumnProperty() {
        ...
        $dbTableProperty->setConstraintProperty(
            new DbColumnConstraintsProperties(DbColumnConstraintType::PRIMARY_KEY, "section_info_id")
        );
        /*$dbTableProperty->setConstraintProperty(
