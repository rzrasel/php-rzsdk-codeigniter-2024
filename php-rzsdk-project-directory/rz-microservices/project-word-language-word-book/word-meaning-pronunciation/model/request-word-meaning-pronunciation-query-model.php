<?php
namespace RzSDK\Model\HTTP\Request\Parameter\Word\Meaning\Pronunciation;
?>
<?php
...
?>
<?php
class RequestWordMeaningPronunciationQueryModel extends GlobalRequestParameterModel {
    ...
    public function getEntryFormName() {
        $parameterModel = new GlobalRequestParameterModel();
        $tempLanguageEntryForm = $parameterModel->word_meaning_pronunciation_form;
        $parameterModel = null;
