...
class SmtpEmailVerification {
    ...
    public function setEmailFrom($email) {
        if (!self::validate($email)) {
            ...
            if ($this->exceptions) {
                throw new SmtpEmailVerificationException($this->ErrorInfo);
            }
        }
        $this->from = $email;
    }
...
$mail = new SmtpEmailVerification();
...
//$mail->setEmailFrom("emailrzrasel@gmail.com");
